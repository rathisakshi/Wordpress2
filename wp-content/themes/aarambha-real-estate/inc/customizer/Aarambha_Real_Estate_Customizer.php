...
class Aarambha_Real_Estate_Customizer {
    ...
    public function aarambha_real_estate_customize_option_fields() {
        ...
        if ( Aarambha_Real_Estate_Helper::crucial_real_state_plugin() ) {
            ...
            require AARAMBHA_REAL_ESTATE_DIV . 'inc/customizer/options/global/Aarambha_Real_Estate_Customize_Global_Property_Builder_Fields.php';
    ...
    public static function aarambha_real_estate_add_sections( $wp_customize ) {
		...
		$sections['property'] = array(
			'title'    => esc_html__( 'Property Builder', 'aarambha-real-estate' ),
			'panel'    => 'aarambha_real_estate_global_panel',
			'priority' => 55,
		);
        /*--------------------------------------------------------------
    ...
    public static function aarambha_real_estate_add_repeater_fields( $wp_customize ) {
        ...
        if ( Aarambha_Real_Estate_Helper::crucial_real_state_plugin() ) {
            ...
            // Property Basic Field Builder
			$wp_customize->add_setting(
				new Aarambha_Real_Estate_Customize_Repeater_Setting(
					$wp_customize,
					'aarambha_real_estate_property_basic_builder_fields',
					array(
						'default'           => array(
							array(
								'name'	=> esc_html__( 'Bed', 'aarambha-real-estate' ),
								'icon'  => 'fa-bed',
								'image'	=> ''
							),
							array(
								'name'  => esc_html__( 'Bath', 'aarambha-real-estate' ),
								'icon'  => 'fa-bath',
								'image'	=> ''
							),
							array(
								'name'  => esc_html__( 'Garage', 'aarambha-real-estate' ),
								'icon'  => 'fa-home',
								'image'	=> ''
							),
							array(
								'name'  => esc_html__( 'Area Size', 'aarambha-real-estate' ),
								'icon'  => 'fa-area-chart',
								'image'	=> ''
							),
							array(
								'name'  => esc_html__( 'Build Year', 'aarambha-real-estate' ),
								'icon'  => 'fa-calendar-alt',
								'image'	=> ''
							),
						),
						'sanitize_callback' => array( 'Aarambha_Real_Estate_Customizer_Sanitize_Callback', 'sanitize_repeater' ),
					)
				)
			);
					...
					array(
						...
						'fields'      => array(
							...
							'icon'      => array(
								...
								'description' => esc_html__( 'Example: fa-bed', 'aarambha-real-estate' ),
							),
							'image'  => array(
								'type'  => 'image',
								'label' => esc_html__( 'Upload Image', 'aarambha-real-estate' ),
							),
						),
						'row_label'   => array(
							'type'  => 'field',
							'value' => esc_html__( 'Field', 'aarambha-real-estate' ),
							'field' => 'name',
						),
						'choices' => [
							'limit' => 5
