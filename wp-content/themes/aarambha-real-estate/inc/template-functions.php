 ...
 * @return array
 */
function aarambha_real_estate_basic_fields() {

	$default = array(
		array(
			'name'	=> esc_html__( 'Beds', 'aarambha-real-estate' ),
			'icon'  => 'fa-bed',
			'image'	=> ''
		),
		array(
...
add_filter( 'cre_property_basic_default_fields', 'aarambha_real_estate_basic_fields' );
